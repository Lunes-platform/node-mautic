...
module.exports = class MauticConnector {
    ...
    _initializeMethods() {
        ...
        this.emails = {
            ...
            sendEmailToContact: (emailId, contactId, tokens) => this._callApi({method: "POST", url: this._makeUrl("/emails/" + emailId + "/contact/" + contactId + "/send"), body: JSON.stringify(tokens)}),
